...
// // путь к вашему исходному файлу db.json
// const dbPath = path.join(__dirname, "db.json");
// const outputPath = path.join(__dirname, "db.normalized.json");
...
// // строим маппинг: name -> id
// const categoryMap = Object.fromEntries(
//   db.categories.map(c => [c.name.toLowerCase(), c.id])
// );

// // пробегаем все транзакции и заменяем categoryId
// const normalizedTransactions = db.transactions.map(tx => ({
//   ...tx,
//   categoryId: categoryMap[tx.categoryId.toLowerCase()] || tx.categoryId
// }));

// // создаём новый объект db с нормализованными транзакциями
// const normalizedDb = {
//   ...db,
//   transactions: normalizedTransactions
// };
